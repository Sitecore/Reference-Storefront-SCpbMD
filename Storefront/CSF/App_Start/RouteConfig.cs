...
namespace Sitecore.Commerce.Storefront
{
    ...
    public static class RouteConfig
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            //    name: "MiniCart",
            //    url: "cart/minicart",
            //    defaults: new { controller = "Cart", action = "MiniCart", id = UrlParameter.Optional });

            //Multi-Storefront Routes
            //routes.MapRoute(
            //    name: "storefronts",
            //    url: "storefronts/{storefront}",
            //    defaults: new { storefront = UrlParameter.Optional, itemType = "storefront" });

            //routes.MapRoute(
            //    name: "contoso",
            //    url: "storefronts/{storefront}/account/register",
            //    defaults: new { controller = "Account", action = "Register", storefront = UrlParameter.Optional });
            ...
            routes.MapRoute(
                name: "MiniCart",
                url: "storefronts/{storefront}/cart/minicart",
                defaults: new { controller = "Cart", action = "MiniCart", storefront = UrlParameter.Optional, updateCart = UrlParameter.Optional });
            ...
            routes.MapRoute(
              name: "CheckoutApplyDiscount",
              url: "checkout/ApplyDiscount",
              defaults: new { controller = "Checkout", action = "ApplyDiscount", id = UrlParameter.Optional });

            routes.MapRoute(
                name: "CheckoutRemoveDiscount",
                url: "checkout/RemoveDiscount",
                defaults: new { controller = "Checkout", action = "RemoveDiscount", id = UrlParameter.Optional });

            routes.MapRoute(
                name: "CheckoutDeleteLineItem",
                url: "checkout/DeleteLineItem",
                defaults: new { controller = "Checkout", action = "DeleteLineItem", id = UrlParameter.Optional });

            routes.MapRoute(
                name: "CheckoutUpdateLineItem",
                url: "checkout/UpdateLineItem",
                defaults: new { controller = "Checkout", action = "UpdateLineItem", id = UrlParameter.Optional });

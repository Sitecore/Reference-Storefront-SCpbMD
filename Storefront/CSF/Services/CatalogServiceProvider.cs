...
namespace Sitecore.Commerce.Storefront.Services
{
    ...
    public class CatalogServiceProvider : ServiceProvider
    {
        ...
        {
            return this.RunPipeline<VisitedCategoryPageRequest, VisitedCategoryPageResult>(Constants.PipelineNames.VisitedCategoryPage, request);
        }
        ...
        {
            return this.RunPipeline<VisitedProductDetailsPageRequest, VisitedProductDetailsPageResult>(Constants.PipelineNames.VisitedProductDetailsPage, request);
        }
    }
}
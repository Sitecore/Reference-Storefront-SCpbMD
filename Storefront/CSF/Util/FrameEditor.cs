...
namespace Sitecore.Commerce.Storefront
{
    ...
    {        
        ...
        public FrameEditor(HtmlHelper html, string dataSource = null, string buttons = null)
        {
            ...
            _editFrameControl = new EditFrame
            {
            ...
            _editFrameControl.RenderFirstPart(output);
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                if (_editFrameControl != null)
                {
                    _editFrameControl.RenderLastPart(new HtmlTextWriter(_html.ViewContext.Writer));
                    _editFrameControl.Dispose();
                }
            }
        }
    }

...
namespace Sitecore.Commerce.Storefront.Models
{
    ...
    public class LandingPageViewModel : Sitecore.Mvc.Presentation.RenderingModel
    {
        ...
        /// <summary>
        /// Gets the display name as a html string
        /// </summary>
        public HtmlString DisplayNameRender
        {
            get
            {
                return PageContext.Current.HtmlHelper.Sitecore().Field(Item["Heading"].ToString(CultureInfo.InvariantCulture), Item);
            }
        }
        ...
        /// <summary>
        /// Gets or sets the AssociatedProductIds
        /// </summary>
        ...
        public void Initialize(Rendering rendering, ProductSearchResults products, CategorySearchResults childCategories, IEnumerable<CommerceQuerySort> sortFields, CommerceSearchOptions searchOptions)
        {
            base.Initialize(rendering);

            ChildProducts = products == null ? new List<Item>() : products.Products;
            ...
            //if (itemsPerPage > products.Products.Count)
            //{
            ...
            //    EndResultIndex = alreadyShown + itemsPerPage
            //};

            //if (childCategories != null)
            //{
            //    this.ChildCategories = childCategories.CategoryItems;
            //}
        }
    }
}
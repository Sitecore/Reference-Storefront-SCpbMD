...
namespace Sitecore.Commerce.Storefront.Models
{
    ...
    public class CategoryViewModel : Sitecore.Mvc.Presentation.RenderingModel
    {
        ...
        {
            return Links.LinkManager.GetDynamicUrl(Item).TrimEnd('/');
        }
        ...
        public void Initialize(Rendering rendering, ProductSearchResults products, IEnumerable<CommerceQuerySort> sortFields, CommerceSearchOptions searchOptions)
        {
            ...
            if (products != null)
            {
                ChildProducts = products.Products;

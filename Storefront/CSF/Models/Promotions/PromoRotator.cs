//-----------------------------------------------------------------------
// <copyright file="PromoRotatorViewModel.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>Defines the PromoRotatorViewModel class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Commerce.Storefront.Models.Promotions
{
    ...
    public class PromoRotator : SitecoreItemBase
    {
        ...
        /// <summary>
        /// Width of the requested Promotion
        /// </summary>
        public int Width
        {
            get
            {
                ...
                {
                     if (int.TryParse(parametersWidth.Get("Width"), out defaultWidth)) return defaultWidth;
                }
        ...
        /// <summary>
        /// Height of the requested Promotion
        /// </summary>
        public int Height
        {
        ...
        {
                    if (int.TryParse(parametersHeight.Get("Height"), out defaultHeight)) return defaultHeight;
                }

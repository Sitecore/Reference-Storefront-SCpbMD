//-----------------------------------------------------------------------
// <copyright file="LoyaltyTransactionItemJsonResult.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>Defines the LoyaltyTransactionItemJsonResult class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Commerce.Storefront.Models.JsonResults
{
    ...
    /// </summary>
    public class LoyaltyTransactionItemJsonResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyTransactionItemJsonResult" /> class.
        /// </summary>
        /// <param name="transaction">The transaction.</param>
        public LoyaltyTransactionItemJsonResult(LoyaltyCardTransaction transaction)
        {

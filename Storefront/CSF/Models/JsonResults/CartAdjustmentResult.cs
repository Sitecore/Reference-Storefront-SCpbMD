//-----------------------------------------------------------------------
// <copyright file="CartAdjustmentJsonResult.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>Defines the CartAdjustmentJsonResult class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Commerce.Storefront.Models.JsonResults
{
    ...
    /// </summary>
    public class CartAdjustmentJsonResult : BaseJsonResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartAdjustmentJsonResult"/> class.
        /// </summary>
        /// <param name="adjustment">The cart adjustment.</param>
        public CartAdjustmentJsonResult(CartAdjustment adjustment)
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating if the adjustment is a charge.
        /// </summary>

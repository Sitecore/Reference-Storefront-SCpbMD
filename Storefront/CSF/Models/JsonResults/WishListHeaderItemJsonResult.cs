//-----------------------------------------------------------------------
// <copyright file="WishListHeaderItemJsonResult.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>Defines the WishListHeaderItemJsonResult class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Commerce.Storefront.Models.JsonResults
{
    ...
    /// </summary>
    public class WishListHeaderItemJsonResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WishListHeaderItemJsonResult"/> class.
        /// </summary>
        /// <param name="header">The wish list header.</param>
        public WishListHeaderItemJsonResult(WishListHeader header)
        {

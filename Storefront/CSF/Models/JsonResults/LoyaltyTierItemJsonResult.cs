//-----------------------------------------------------------------------
// <copyright file="LoyaltyTierItemJsonResult.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2015
// </copyright>
// <summary>Defines the LoyaltyTierItemJsonResult class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Commerce.Storefront.Models.JsonResults
{
    ...
    /// </summary>
    public class LoyaltyTierItemJsonResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyTierItemJsonResult" /> class.
        /// </summary>
        /// <param name="tier">The tier.</param>
        /// <param name="cardTier">The card tier.</param>
        public LoyaltyTierItemJsonResult(LoyaltyTier tier, LoyaltyCardTier cardTier)
        {

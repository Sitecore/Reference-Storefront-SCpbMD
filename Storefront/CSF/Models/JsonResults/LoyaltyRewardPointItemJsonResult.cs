...
namespace Sitecore.Commerce.Storefront.Models.JsonResults
{
    ...
    /// </summary>
    public class LoyaltyRewardPointItemJsonResult
    {
        private readonly List<LoyaltyTransactionItemJsonResult> _transactions = new List<LoyaltyTransactionItemJsonResult>();
        ...
        public LoyaltyRewardPointItemJsonResult(LoyaltyRewardPoint rewardPoint)
        {
            ...
            {
                this._transactions.Add(new LoyaltyTransactionItemJsonResult(transaction));
            }
        }
        ...
        /// The transactions.
        /// </value>
        public List<LoyaltyTransactionItemJsonResult> Transactions
        {
            get
            {
